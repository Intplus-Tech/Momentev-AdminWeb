...
export default function CommissionsTable() {
  ...
  // Form State
  const [formData, setFormData] = useState<{ type: "flat_rate" | "percentage", amount: string }>({
    type: "percentage",
    amount: "",
  });
  ...
  const handleOpenAdd = () => {
    setFormData({ type: "percentage", amount: "" });
      ...
      <div className="p-6 border-b border-gray-100 flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage GBP commissions charged to vendors.
          </p>
        </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    type="number"
                    className={formData.type === "flat_rate" ? "pl-7" : undefined}
                    placeholder={formData.type === "percentage" ? "e.g. 10" : "e.g. 25"}
